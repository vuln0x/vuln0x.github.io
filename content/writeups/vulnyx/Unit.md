...
status: "active"
featured: false
featured_image: "/images/writeups/vulnyx/Unit.png"
tags: ["linux", "nginx", "http-methods", "file-upload", "rce", "sudo", "gtfobins"]
skills: ["nmap", "curl", "php", "netcat", "linux-enumeration", "gtfobins"]
comments: false
draft: false
---
---
...
<img width="842" height="438" alt="image" src="/images/writeups/vulnyx/Unit.png" />

Unit is an easy VulNyx machine focused on abusing dangerous HTTP methods, arbitrary file uploads, remote code execution, and privilege escalation through insecure sudo permissions. The challenge demonstrates how insecure web server configurations combined with GTFOBins techniques can lead to complete system compromise.
