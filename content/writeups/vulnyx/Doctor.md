...
A VulNyx machine involving Local File Inclusion (LFI), SSH key extraction, passphrase cracking, and privilege escalation through a misconfigured writable `/etc/passwd` file.
