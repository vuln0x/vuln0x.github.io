---
title: "VisionLab | Vulnyx Writeup"
date: 2026-08-19T00:08:21+05:30
...
status: "active"
featured: true
featured_image: "/images/writeups/vulnyx/VisionLab.png"
tags: ["linux", "pytorch", "torch-load", "deserialization", "rce", "reverse-shell", "ssh", "ssh-key", "sudo", "dmidecode", "CVE-2023-30630", "privilege-escalation"]
skills: ["nmap", "gobuster", "python", "pytorch", "pickle", "netcat", "ssh", "ssh-keygen", "sudo", "dmidecode", "dmiwrite", "linux-enumeration", "privilege-escalation"]
comments: false
draft: false
---
...
<img width="842" height="438" alt="visionlab-vulnyx" src="/images/writeups/vulnyx/VisionLab.png" />

VisionLab is an easy VulNyx machine that focuses on insecure PyTorch model uploads, Python deserialization, remote code execution, SSH access, and privilege escalation through misconfigured sudo permissions. The machine demonstrates how applications that process untrusted machine-learning models can become an initial access vector and how an overly permissive `dmidecode` configuration can ultimately lead to root access.
