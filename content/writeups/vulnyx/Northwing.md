---
title: "NorthWing | Vulnyx Writeup"
date: 2026-08-26T11:56:38+05:30
description: "VulNyx NorthWing writeup covering Local File Inclusion, PHP filter wrapper bypass, SSH private key disclosure, credential cracking, MySQL enumeration, and privilege escalation through misconfigured systemctl sudo permissions."
summary: "Compromised the NorthWing machine by exploiting Local File Inclusion with a PHP filter wrapper, recovering and cracking an SSH private key to access arthur, extracting database credentials and a developer password, then escalating to root through unrestricted systemctl sudo permissions and a SUID Bash."
platform: "vulnyx"
difficulty: "easy"
os: "Linux"
status: "active"
featured: true
featured_image: "/images/writeups/vulnyx/Northwing.png"
tags: ["linux", "lfi", "php-filter", "ssh", "ssh-key", "john-the-ripper", "credentials", "mysql", "password-cracking", "sudo", "systemctl", "suid", "bash", "privilege-escalation"]
skills: ["nmap", "lfi", "php-filter-wrapper", "base64", "ssh", "ssh2john", "john-the-ripper", "linux-enumeration", "mysql", "sudo", "systemctl", "suid", "bash", "privilege-escalation"]
comments: false
draft: false
---
...
<img width="842" height="438" alt="northwing-vulnyx" src="/images/writeups/vulnyx/Northwing.png" />

NorthWing is an easy VulNyx machine that focuses on Local File Inclusion, PHP filter wrapper bypasses, SSH private key disclosure, password cracking, credential disclosure, MySQL enumeration, and privilege escalation through misconfigured `systemctl` sudo permissions. The machine demonstrates how a file inclusion vulnerability can lead to credential disclosure and initial access, which can then be chained with weak credentials and an overly permissive system administration utility to achieve full system compromise.
