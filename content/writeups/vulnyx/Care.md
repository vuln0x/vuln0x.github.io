---
title: "Care | Vulnyx Writeup"
date: 2026-07-30T21:34:35+05:30
description: "VulNyx Care writeup covering Local File Inclusion (LFI), Squid log poisoning, Remote Code Execution (RCE), privilege escalation via misconfigured sudo permissions, and KeePass credential recovery."
summary: "Compromised the Care machine by exploiting a Local File Inclusion vulnerability to poison Squid proxy logs and achieve Remote Code Execution, pivoted to another user through a misconfigured sudo rule, recovered a KeePass database, cracked its master password, and obtained root credentials."
platform: "vulnyx"
difficulty: "easy"
os: "Linux"
status: "active"
featured: false
featured_image: "/images/writeups/vulnyx/Care.png"
tags: ["linux", "lfi", "squid", "log-poisoning", "keepass", "sudo", "privilege-escalation"]
skills: ["nmap", "curl", "netcat", "perl", "keepass4brute", "keepassxc"]
comments: false
draft: false
---
