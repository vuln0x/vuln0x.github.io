---
title: "Explorer | Vulnyx Writeup"
date: 2026-08-17T23:13:51+05:30
description: "VulNyx Explorer writeup covering exposed eXtplorer through robots.txt, default credentials, PHP web shell upload, reverse shell access, plaintext root credential disclosure, and privilege escalation via su."
summary: "Compromised the Explorer machine by discovering eXtplorer through robots.txt, authenticating with default credentials, creating a PHP web shell, obtaining a reverse shell as www-data, extracting root credentials from a PHP configuration file, and switching to the root account."
platform: "vulnyx"
difficulty: "easy"
os: "Linux"
status: "active"
featured: false
featured_image: "/images/writeups/vulnyx/Explorer.png"
tags: ["linux", "extplorer", "default-credentials", "web-shell", "rce", "reverse-shell", "credentials", "privilege-escalation"]
skills: ["nmap", "gobuster", "robots-txt", "extplorer", "php", "netcat", "linux-enumeration", "su"]
comments: false
draft: false
---
...
<img width="842" height="438" alt="image" src="/images/writeups/vulnyx/Explorer.png" />
