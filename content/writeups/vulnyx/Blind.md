...
date: 2026-08-22T12:11:22+05:30
description: "VulNyx Blind writeup covering command injection through DNSRecon GUI, reverse shell access, hardcoded credential disclosure, and privilege escalation through JShell and SUID Bash."
summary: "Compromised the Blind machine by exploiting command injection in the DNSRecon GUI, obtaining a reverse shell as microjoan, recovering hardcoded credentials from the application source, and escalating privileges through sudo access to JShell and SUID Bash."
platform: "vulnyx"
difficulty: "easy"
os: "Linux"
status: "active"
featured: true
featured_image: "/images/writeups/vulnyx/Blind.png"
tags: ["linux", "command-injection", "dnsrecon", "reverse-shell", "credentials", "hardcoded-credentials", "sudo", "jshell", "suid", "bash", "privilege-escalation"]
skills: ["nmap", "robots-txt", "dnsrecon", "command-injection", "netcat", "linux-enumeration", "php", "credential-discovery", "sudo", "jshell", "suid", "bash", "privilege-escalation"]
comments: false
draft: false
---
...
<img width="842" height="438" alt="blind-vulnyx" src="/images/writeups/vulnyx/Blind.png" />
