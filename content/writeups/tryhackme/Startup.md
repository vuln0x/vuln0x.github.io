...
date: 2026-07-25T18:11:50+05:30
description: "TryHackMe Startup writeup covering Anonymous FTP access, arbitrary file upload, Remote Code Execution (RCE), credential disclosure through packet capture analysis, and privilege escalation via a writable root cron script."
summary: "Compromised the Startup machine by abusing an anonymous writable FTP share to upload a PHP web shell, recovered SSH credentials from a packet capture, and escalated privileges by modifying a root-executed cron script to obtain a SUID Bash shell."
platform: "tryhackme"
difficulty: "easy"
os: "Linux"
status: "active"
